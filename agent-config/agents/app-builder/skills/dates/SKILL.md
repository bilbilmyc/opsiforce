---
name: dates
description: Practical workflow for date-fns v4 and native @date-fns/tz usage, covering imports, parsing/formatting, calculations, timezone-safe patterns, calendar pickers (react-day-picker), and common pitfalls. Use whenever working with dates, timestamps, durations, calendars, due dates, schedule windows, time zones, or any timezone-sensitive computation.
---
...
- `references/core-functions.md` for essential helpers.
- `references/native-timezones.md` for `@date-fns/tz` patterns.
- `references/imports-and-practices.md` for import/runtime practices.
- `references/format-parse-tokens.md` for token correctness.
- `references/examples.md` for copy-ready snippets.
- `references/anti-patterns.md` for strict "never use `date-fns-tz`" guidance.
- `references/version-and-sources.md` for version checks and source links.
- `references/picker.md` for `react-day-picker` UI (project-specific: single date, date range, constrained pickers, react-hook-form integration).
