...
2026-09-16 进度：阶段 1a 已实现版本 1 启动清单及旧入口兼容；阶段 1b 新增独立 FastAPI/Go 实验模板与显式初始化，详见 [后端模板](../runtime/backend-templates.md)。创建页面、配方专属 Agent 指令和前端组合尚未接入，不能视为下表阶段 2 已完成。
