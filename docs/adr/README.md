...
| [0026](0026-chat-boot-suspense-contained-and-covered.md) | Chat boot suspense is contained in a local boundary and covered by the connecting spinner until the session lineage resolves | implemented; fixes the blank project view after the opencode 1.18.18 upgrade |
