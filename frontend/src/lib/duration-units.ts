...
export const TIME_UNITS = [
  { value: 'minutes', get label() { return t("Minutes"); }, multiplier: 60 * 1000 },
  { value: 'hours', get label() { return t("Hours"); }, multiplier: 60 * 60 * 1000 },
  { value: 'days', get label() { return t("Days"); }, multiplier: 24 * 60 * 60 * 1000 },
];
