    ...
    >
      ...
      <div class="flex items-start gap-2.5">
        ...
        <div class="min-w-0 flex-1">
              ...
              <Show
                ...
                fallback={
                  <>
                    ...
                    <Show when={job()?.error}>
                      <p class="mt-0.5 line-clamp-2 break-words text-xs text-muted-foreground">{job()?.error}</p>
                    </Show>
                  </>
                }
              >
                <p class="text-xs font-semibold text-foreground">{props.entry.environmentName} is live</p>
          ...
          >
            <p class="text-xs font-semibold text-foreground">Publishing to {props.entry.environmentName}</p>
