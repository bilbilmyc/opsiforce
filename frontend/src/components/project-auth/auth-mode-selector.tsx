...
const OPTIONS: ModeOption[] = [
  {
    ...
    title: "Public",
    description:
      "Anyone can access this project's preview URL without signing in.",
    icon: Globe,
  },
  {
    value: "makara",
    title: "Makara",
    description:
      "Reuse the existing Makara Keycloak sign-in — no configuration needed.",
    icon: ShieldCheck,
  },
  {
    value: "manual",
    title: "Manual",
    description:
      "Require login via a custom auth provider before the preview loads.",
    icon: Lock,
  },
];
