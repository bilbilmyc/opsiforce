      ...
      <Show when={props.mode === "full"}>
        <div class="space-y-2.5 border-t border-border pt-3">
          ...
          <p class="text-xs text-muted-foreground/70">
            Maximum size of each request and response body kept in the log. Larger bodies are
            truncated at capture time, so they never buffer in the proxy. Max 256 KB.
          </p>
          <NumberField
            class="w-32"
            minValue={0}
