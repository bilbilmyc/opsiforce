...
export const dict = {
  ...
  "ui.message.reasoning.waiting": "模型尚未返回思考内容，收到后会在这里实时显示。",
  "ui.message.thought": "思考过程",
  "ui.messagePart.context.notice.one": "{{count}} 条提示",
  "ui.messagePart.context.notice.other": "{{count}} 条提示",
  "ui.messagePart.context.thought.one": "{{count}} 段思考",
  "ui.messagePart.context.thought.other": "{{count}} 段思考",
  "ui.messagePart.tools.used": "查看{{tools}}",
  "ui.promptInput.placeholder.followUp": "继续对话，{{slash}} 查看命令，{{at}} 添加上下文…",
  "ui.sessionTimeline.notice.model": "模型",
  "ui.sessionTimeline.notice.modelSwitched": "已切换到 {{model}}",
  "ui.sessionTimeline.notice.agentChanged": "智能体已切换",
